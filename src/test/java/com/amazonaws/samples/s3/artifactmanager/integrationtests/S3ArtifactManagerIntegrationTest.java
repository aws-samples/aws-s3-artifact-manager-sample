...
public class S3ArtifactManagerIntegrationTest {
	...
	public void testUploadWillCreateBucketWithVersioningEnabled() throws Exception {
		...
		BucketVersioningConfiguration bucketConfig = s3Client.getBucketVersioningConfiguration(s3Bucket);
	...
	public void testUploadAddsSSE_S3EncryptedObjectToBucket() throws Exception {
		...
		ObjectMetadata s3ObjectMetadata = s3Client.getObjectMetadata(new GetObjectMetadataRequest(s3Bucket, s3Key));
